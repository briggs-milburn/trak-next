...
export default function Dialog({
  ...
  return (
    <>
      <div className="fixed inset-0 bg-opacity-10 z-40" />
      <div
        className="fixed inset-0 z-50 flex items-center justify-center overflow-auto bg-opacity-40 backdrop-blur-sm"
        role="dialog"
        aria-modal="true"
